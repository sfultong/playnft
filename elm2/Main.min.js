...
var $author$project$Main$ArtListingsInterface = {$: 'ArtListingsInterface'};
...
var $author$project$Main$AdminInterface = {$: 'AdminInterface'};
var $author$project$Main$ArtistInterface = {$: 'ArtistInterface'};
...
var $author$project$Main$routeParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			A2($elm$url$Url$Parser$map, $author$project$Main$ArtListingsInterface, $elm$url$Url$Parser$top),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$ArtistInterface,
			$elm$url$Url$Parser$s('artist')),
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Main$AdminInterface,
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		...
		var _v2 = A2(
			...
			url,
			{
				artListings: _List_Nil,
				artistState: {artFile: $elm$core$Maybe$Nothing, datePicker: datePicker, imagePreview: '', loggedArtist: $elm$core$Maybe$Nothing, newListingErrorVisibility: $rundis$elm_bootstrap$Bootstrap$Alert$closed, selectedAuctionEndDate: $elm$core$Maybe$Nothing, title: ''},
				navKey: key,
				navState: navState,
				page: $author$project$Main$ArtListingsInterface,
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						A2($elm$core$Task$perform, $author$project$Main$ReceiveDate, $justinmimbs$date$Date$today),
						urlCmd,
						navCmd,
						A2($elm$core$Platform$Cmd$map, $author$project$Main$ToDatePicker, datePickerFx)
					])));
	});
var $author$project$Main$PrepareListing = function (a) {
	return {$: 'PrepareListing', a: a};
};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2($rundis$elm_bootstrap$Bootstrap$Alert$subscriptions, model.artistState.newListingErrorVisibility, $author$project$Main$PrepareListing)
			]));
};
var $author$project$Main$GotPreview = function (a) {
	return {$: 'GotPreview', a: a};
};
var $author$project$Main$GotSelectedFile = function (a) {
	return {$: 'GotSelectedFile', a: a};
};
var $author$project$Main$NewListing = function (a) {
	return {$: 'NewListing', a: a};
};
...
var $author$project$Main$fromJust = function (mx) {
	if (mx.$ === 'Just') {
		var x = mx.a;
		return x;
	} else {
...
var $author$project$Main$setArtFile = F2(
	function (sart, file) {
		return _Utils_update(
			sart,
			{
				artFile: $elm$core$Maybe$Just(file)
			});
	});
var $author$project$Main$setArtist = F2(
	function (sart, str) {
		return (str === '') ? _Utils_update(
			sart,
			{loggedArtist: $elm$core$Maybe$Nothing}) : _Utils_update(
			sart,
			{
				loggedArtist: $elm$core$Maybe$Just(
					{name: str})
			});
	});
var $author$project$Main$setArtistState = F2(
	function (model, sart) {
		return _Utils_update(
			model,
			{artistState: sart});
	});
var $author$project$Main$setDate = F2(
	function (sart, date) {
		return _Utils_update(
			sart,
			{selectedAuctionEndDate: date});
	});
var $author$project$Main$setDatePicker = F2(
	function (sart, dp) {
		return _Utils_update(
			sart,
			{datePicker: dp});
	});
var $author$project$Main$setImagePreview = F2(
	function (url, sart) {
		return _Utils_update(
			sart,
			{imagePreview: url});
	});
var $author$project$Main$setPrepareListingErrorVisibility = F2(
	function (sart, av) {
		return _Utils_update(
			sart,
			{newListingErrorVisibility: av});
	});
...
var $author$project$Main$settings = _Utils_update(
	$CurrySoftware$elm_datepicker$DatePicker$defaultSettings,
	{
		...
		inputName: $elm$core$Maybe$Just('date'),
		isDisabled: function (x) {
			return false;
		}
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'SetArtist':
				...
				return _Utils_Tuple2(
					A2(
						$author$project$Main$setArtistState,
						model,
						A2($author$project$Main$setArtist, model.artistState, str)),
					$elm$core$Platform$Cmd$none);
			case 'SetTitle':
				var str = msg.a;
				return _Utils_Tuple2(
					A2(
						$author$project$Main$setArtistState,
						model,
						A2($author$project$Main$setTitle, model.artistState, str)),
					$elm$core$Platform$Cmd$none);
			case 'PrepareListing':
				var av = msg.a;
				return ((model.artistState.imagePreview === '') || (_Utils_eq(model.artistState.artFile, $elm$core$Maybe$Nothing) || ((model.artistState.title === '') || (_Utils_eq(model.artistState.selectedAuctionEndDate, $elm$core$Maybe$Nothing) || (_Utils_eq(model.artistState.loggedArtist, $elm$core$Maybe$Nothing) || _Utils_eq(model.today, $elm$core$Maybe$Nothing)))))) ? _Utils_Tuple2(
					A2(
						$author$project$Main$setArtistState,
						model,
						A2($author$project$Main$setPrepareListingErrorVisibility, model.artistState, $rundis$elm_bootstrap$Bootstrap$Alert$shown)),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					A2(
						$author$project$Main$setArtistState,
						model,
						A2($author$project$Main$setPrepareListingErrorVisibility, model.artistState, av)),
					A2(
						$elm$core$Task$perform,
						$author$project$Main$NewListing,
						$elm$core$Task$succeed(
							{
								art: $author$project$Main$fromJust(model.artistState.artFile),
								artist: $author$project$Main$fromJust(model.artistState.loggedArtist),
								biddingEnding: $author$project$Main$fromJust(model.artistState.selectedAuctionEndDate),
								biddingStart: $author$project$Main$fromJust(model.today),
								petitions: _List_Nil,
			...
			case 'ToDatePicker':
				var subMsg = msg.a;
				var _v1 = A3($CurrySoftware$elm_datepicker$DatePicker$update, $author$project$Main$settings, subMsg, model.artistState.datePicker);
					...
					function () {
						if (event.$ === 'Picked') {
							...
							return A2(
								...
								model,
								A2(
									$author$project$Main$setDatePicker,
									A2(
										$author$project$Main$setDate,
										model.artistState,
							...
							return A2(
								$author$project$Main$setArtistState,
								model,
								A2($author$project$Main$setDatePicker, model.artistState, newDatePicker));
						}
					}(),
					$elm$core$Platform$Cmd$none);
			case 'GotPreview':
				...
				return _Utils_Tuple2(
					A2(
						$author$project$Main$setArtistState,
						model,
						A2($author$project$Main$setImagePreview, url, model.artistState)),
					$elm$core$Platform$Cmd$none);
			case 'GotSelectedFile':
				var file = msg.a;
				return _Utils_Tuple2(
					A2(
						$author$project$Main$setArtistState,
						model,
						A2($author$project$Main$setArtFile, model.artistState, file)),
					A2(
						$elm$core$Task$perform,
						$author$project$Main$GotPreview,
			...
			case 'PickFile':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['image/*']),
						$author$project$Main$GotSelectedFile));
			case 'ClickedLink':
				var req = msg.a;
				if (req.$ === 'Internal') {
					var url = req.a;
...
var $author$project$Main$pageAdminInterface = function (model) {
	return _List_fromArray(
		[
			A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Administrator Interface')
								])),
							A2($elm$html$Html$br, _List_Nil, _List_Nil)
						]))
				])),
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Artist adress:')
								]))
						])),
					A2(
					$rundis$elm_bootstrap$Bootstrap$Grid$col,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$placeholder('your art\'s tile'),
...
var $author$project$Main$makeCardFromListing = function (artListing) {
		...
		A3(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Artist: ' + artListing.artist.name)
						])),
					A2(
					$rundis$elm_bootstrap$Bootstrap$Card$Block$text,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Bidding ending at' + $justinmimbs$date$Date$toIsoString(artListing.biddingEnding))
						]))
				]),
			A3(
				...
				_List_fromArray(
					[
						$author$project$Main$viewPreview(artListing.preview)
					]),
				A3(
					...
					_List_fromArray(
						[
							$elm$html$Html$text(artListing.title)
						]),
					$rundis$elm_bootstrap$Bootstrap$Card$config(
						_List_fromArray(
							[$rundis$elm_bootstrap$Bootstrap$Card$outlinePrimary]))))));
};
var $author$project$Main$pageArtListingsInterface = function (model) {
	return _List_fromArray(
		[
			A2(
			$rundis$elm_bootstrap$Bootstrap$Grid$row,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Art Listings')
								])),
							A2($elm$html$Html$br, _List_Nil, _List_Nil)
						]))
				])),
			...
			_List_fromArray(
				[
					...
					$rundis$elm_bootstrap$Bootstrap$Grid$col,
					_List_Nil,
					A2($elm$core$List$map, $author$project$Main$makeCardFromListing, model.artListings))
				]))
		]);
};
var $author$project$Main$artistListingsTab = function (model) {
	return _List_fromArray(
		[
			$elm$html$Html$text('Artist\'s listings from function')
		]);
};
var $author$project$Main$PickFile = {$: 'PickFile'};
var $author$project$Main$SetTitle = function (a) {
	return {$: 'SetTitle', a: a};
};
...
var $author$project$Main$artistNewArtListingTab = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$h2,
			...
			_List_fromArray(
				[
					$elm$html$Html$text(model.artistState.title)
				])),
			A2(
			$elm$html$Html$input,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$placeholder('your art\'s tile'),
					$elm$html$Html$Events$onInput($author$project$Main$SetTitle)
				]),
			_List_Nil),
			$author$project$Main$viewPreview(model.artistState.imagePreview),
			A2(
			$rundis$elm_bootstrap$Bootstrap$Button$button,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Pick a date:')
				])),
			A2(
			$elm$html$Html$map,
			$author$project$Main$ToDatePicker,
			A3($CurrySoftware$elm_datepicker$DatePicker$view, model.artistState.selectedAuctionEndDate, $author$project$Main$settings, model.artistState.datePicker)),
			A2(
			$rundis$elm_bootstrap$Bootstrap$Button$button,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick(
							$author$project$Main$PrepareListing($rundis$elm_bootstrap$Bootstrap$Alert$closed))
						]))
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('New Art Listing')
				])),
			A2(
			$rundis$elm_bootstrap$Bootstrap$Alert$view,
			model.artistState.newListingErrorVisibility,
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Not a complete art listing')
							])),
						$elm$html$Html$text('You must select a file and an auction date end.')
					]),
				$rundis$elm_bootstrap$Bootstrap$Alert$warning($rundis$elm_bootstrap$Bootstrap$Alert$config)))
		]);
};
var $author$project$Main$SetArtist = function (a) {
	return {$: 'SetArtist', a: a};
};
var $author$project$Main$artistProfileTab = function (model) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$h2,
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					function () {
						var _v0 = model.artistState.loggedArtist;
						if (_v0.$ === 'Just') {
							var artist = _v0.a;
							return 'Welcome, ' + (artist.name + '!');
						} else {
							return 'Hello, stranger! Specify your artist name to log in.';
						}
					}())
				])),
			A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$placeholder('Artist\'s name'),
					$elm$html$Html$Events$onInput($author$project$Main$SetArtist)
				]),
			_List_Nil)
		]);
};
...
var $author$project$Main$pageArtistInterface = function (model) {
	return _List_fromArray(
		[
			A2(
			$rundis$elm_bootstrap$Bootstrap$Grid$row,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Artist Interface')
								])),
							A2($elm$html$Html$br, _List_Nil, _List_Nil)
						]))
				])),
									...
									[
										$rundis$elm_bootstrap$Bootstrap$Tab$item(
										{
											...
											link: A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$text('My Listings')
													])),
											pane: A2(
												$rundis$elm_bootstrap$Bootstrap$Tab$pane,
												_List_Nil,
												$author$project$Main$artistListingsTab(model))
										}),
										$rundis$elm_bootstrap$Bootstrap$Tab$item(
										{
											id: 'newArtListingTab',
											...
											pane: A2(
												$rundis$elm_bootstrap$Bootstrap$Tab$pane,
												_List_Nil,
												$author$project$Main$artistNewArtListingTab(model))
										}),
										$rundis$elm_bootstrap$Bootstrap$Tab$item(
										{
											id: 'artistProfileTab',
											...
											pane: A2(
												$rundis$elm_bootstrap$Bootstrap$Tab$pane,
												_List_Nil,
												$author$project$Main$artistProfileTab(model))
										})
									]),
...
var $author$project$Main$mainContent = function (model) {
	return A2(
		...
		function () {
			var _v0 = model.page;
			switch (_v0.$) {
				case 'ArtListingsInterface':
					return $author$project$Main$pageArtListingsInterface(model);
				case 'ArtistInterface':
					return $author$project$Main$pageArtistInterface(model);
				case 'AdminInterface':
					return $author$project$Main$pageAdminInterface(model);
				default:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href('#artist')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Artist Interface')
...
var $author$project$Main$view = function (model) {
	var _v0 = A2($elm$core$Debug$log, 'model!!!!!!!!!!!!!!!!!!!!!!!!!!!!1', model);
	return {
